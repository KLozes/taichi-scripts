...
Q = ti.Vector.field(4, dtype=real)  # [rho, rho*u, rho*v, rho*e] consv vars
Q_old = ti.Vector.field(4, dtype=real)
W = ti.Vector.field(4, dtype=real)  # [rho, u, v, p] cell avg
F_x = ti.Vector.field(4, dtype=real)  # x-face flux
F_y = ti.Vector.field(4, dtype=real)  # y-face flux

blks = ti.root.dense(ti.ij, N//block_size)

for f in [Q, W, Q_old, F_x, F_y]:
    blks.dense(ti.ij, block_size).place(f)
